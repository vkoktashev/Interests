...
from utils.constants import CACHE_TIMEOUT, LANGUAGE, rawg
from utils.functions import update_fields_if_needed, get_rawg_game_key, get_tmdb_movie_key, get_tmdb_show_key, \
    get_tmdb_episode_key
...
def update_upcoming_games_dates():
    # todo сохранять tba чтобы сократить количество запросов
