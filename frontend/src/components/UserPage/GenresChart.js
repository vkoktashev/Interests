	...
	return (
		<div hidden={hidden}>
			{/Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (
				<BarChart width={document.body.clientWidth - 25} height={chartData.length * 40} data={chartData} margin={{ top: 5, right: 0, left: 45, bottom: 20 }} layout='vertical'>
				...
				<BarChart width={Math.min(chartData.length * 100, document.body.clientWidth)} height={300} data={chartData} margin={{ top: 5, right: 10, left: 10, bottom: 15 }}>
