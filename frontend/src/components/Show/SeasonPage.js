...
import { AreaChart, linearGradient, XAxis, Tooltip, YAxis, Area } from "recharts";
import "./style.css";
							...
							<MDBContainer>
								...
								<div className='showContentBody'>
									...
									<div hidden={!(chartData.length > 0)}>
										<AreaChart width={700} height={250} data={chartData} margin={{ top: 20, right: 20, left: 15, bottom: 0 }}>
											<defs>
