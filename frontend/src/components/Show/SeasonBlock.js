...
function SeasonBlock ( {showID, seasonNumber, loggedIn, openLoginForm,
        showSeason, showSeasonIsLoading, showUserInfo, 
        requestShowSeason, requestShowSeasonUserInfo, setShowEpisodeUserStatus, onChangeStatus, setShowSeasonUserStatus, userWatchedShow} ) {
