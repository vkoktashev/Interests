...
function TimeToBeat({ hltbInfo }) {
	return (
		<div hidden={!hltbInfo || (hltbInfo?.gameplay_main < 0 && hltbInfo?.gameplay_main_extra < 0 && hltbInfo?.gameplay_completionist < 0)}>
			...
			<div hidden={!hltbInfo && !hltbInfo?.gameplay_main} style={{ display: "inline" }}>
			...
			<div hidden={!hltbInfo?.gameplay_main_extra} style={{ display: "inline" }}>
			...
			<p style={{ display: "inline" }}> </p>
			<div hidden={!hltbInfo?.gameplay_completionist} style={{ display: "inline" }}>
