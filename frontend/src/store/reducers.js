...
const initialState = Map(
    {
        ...
        isLoading: {contentGame: false, contentMovie: false, searchGames: false, searchMovies: false, userPageContent: false, searchUsers: false, userPageLogs: false, userPageFriendsLogs: false, contentGameFriends: false}
    }
);
...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.SET_CONTENT_MOVIE: return state.setIn(['content', 'movie'], action.movie);
    case types.SET_CONTENT_MOVIE_USERINFO: return state.setIn(['content', 'movie', 'user_info'], action.user_info);
...
export function getContentMovie(state) { return state.get('content').movie; }
