...
export default {
    ...
    'form.DropDownFieldItemView': {lazy: () => require('./form/DropDownFieldItem/DropDownFieldItemView').default},
    ...
    'form.RadioFieldView': {lazy: () => require('./form/RadioField/RadioFieldView').default},
